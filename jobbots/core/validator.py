...
def validate_questions() -> None | ValueError | TypeError:
    ...
    check_string(professional_profile_url, "professional_profile_url")
    ...
    check_string(profile_headline, "profile_headline")
    check_int(notice_period, "notice_period")
    check_int(current_ctc, "current_ctc")
    check_string(profile_summary, "profile_summary")
...
def validate_secrets() -> None | ValueError | TypeError:
    ...
    if ai_provider == "deepseek":
        check_string(llm_model, "deepseek_model", ["deepseek-chat", "deepseek-reasoner", "deepseek/deepseek-chat", "deepseek/deepseek-r1"])
    else:
...
def validate_settings() -> None | ValueError | TypeError:
    ...
    check_boolean(use_groq_job_gate, "use_groq_job_gate")
    ...
    check_boolean(use_capmonster_captcha_solver, "use_capmonster_captcha_solver")
