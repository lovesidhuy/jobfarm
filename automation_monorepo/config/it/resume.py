...
elif (_repo_root / "profiles" / "resumes" / "sample_resume_it.pdf").is_file():
    default_resume_path = str(_repo_root / "profiles" / "resumes" / "sample_resume_it.pdf")
else:
    default_resume_path = str(_repo_root / "profiles" / "resumes" / "sample_resume_it.pdf")
